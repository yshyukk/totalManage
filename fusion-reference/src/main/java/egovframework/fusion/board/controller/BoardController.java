...
public class BoardController {
	...
	public String boardList(@ModelAttribute PagingVO pagingVo, BoardVO boardVO, Model model) throws Exception {
			
			int total = boardService.searchResultTotal(pagingVo);

			pagingVo.setTotal(total);
			
			/* boardList 출력 */
			List<BoardVO> boardList = boardService.getBoardList(pagingVo);
			List<BoardVO> notice = boardService.getNoticeList(pagingVo);
