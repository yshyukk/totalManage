			...
			<div id="ins_container" class="card-body">
				...
				<form name="form_contents " id="form_contents" method="post" enctype="multipart/form-data">
					...
					<div id="show_hashtag" class="hashTag form-control" style="display:inline-block; border:1px solid lightgray;">
						<ul id="hashTag_list" style="list-style:none; display:flex">
							<!-- 태그 보여줄 부분 -->
						</ul>
					</div>
					<div class="mb-3">
	...
	$(document).ready(function(){
		...
		$("#ins_hashTag").on("click", function(e){
			...
			if(hashTagVal !== ""){
				...
				if(result.length == 0){
					$("#hashTag_list").append("<li class='hashTag_item' style='list-style:none; margin-right:10px'>" + "<span class='span_hashTag' style='font-size:20px'>" +hashTagVal +"</span>" + 
											  "<button type='button' style='background-color:transparent; margin-left:10px; border:none; color:red;' class='del_btn' idx='" + counter + "'>x</button></li>");
